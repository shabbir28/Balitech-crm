...
const DownloadPanel = ({ rowId, onClose }) => {
    ...
    useEffect(() => {
        api.get(`/premium-download/logs/${rowId}/file`)
...
const PremiumAlreadyDownloaded = () => {
    ...
    const fetchList = useCallback(async () => {
        ...
        setError('');
        try {
            // Fixed URL: was /premium-already-downloaded, correct is /already-downloaded
            const res = await api.get('/premium-download/already-downloaded/list?limit=500');
...
export default PremiumAlreadyDownloaded;
