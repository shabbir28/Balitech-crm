...
// import ReCAPTCHA from "react-google-recaptcha"; // disabled for localhost
            ...
            <div className="w-full max-w-[420px] relative z-10 transition-all duration-300">
                ...
                <div className="bg-[#1e1e2d] border border-[#ffffff0a] shadow-[0_0_40px_rgba(0,0,0,0.3)] rounded-2xl overflow-hidden">
                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            {/* reCAPTCHA disabled for localhost — uncomment before production
                ...
                <div className="flex flex-col items-center gap-2 mt-8">
                    ...
                    <div className="flex justify-center mt-6">
                        <div className="flex items-center gap-4 px-6 py-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 group cursor-default shadow-lg">
                            <span className="text-[13px] tracking-[0.2em] uppercase text-slate-300 font-semibold transition-colors">Powered by</span>
                            <div className="w-px h-6 bg-white/20 transition-colors" />
                            <img
                                src="/assets/Go Connectivo 1.png"
                                alt="GO Connectivo"
                                className="h-8 w-auto object-contain opacity-100 brightness-110 drop-shadow-sm"
                            />
                        </div>
                    </div>
