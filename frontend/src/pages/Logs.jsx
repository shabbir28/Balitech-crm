...
import { Download, Filter, UserCircle, Calendar, Hash } from 'lucide-react';
                ...
                <div className="overflow-x-auto relative z-10 w-full">
                    <table className="w-full text-left text-[14px]">
                        <thead className="bg-[#0a0a0f]/80 backdrop-blur-md text-slate-400 font-bold uppercase tracking-widest text-[11px] border-b border-white/10">
                            <tr>
                                <th className="p-5 font-bold flex items-center gap-2">
                                    <UserCircle className="w-4 h-4 opacity-70" /> Agent
                                </th>
                                ...
                                <th className="p-5 font-bold">Vendor Status</th>
                                <th className="p-5 font-bold">
                        ...
                        <tbody className="divide-y divide-white/5 text-slate-200">
                            {loading ? (
                                <tr>
                                    <td colSpan="5" className="p-12 text-center text-brand-400 animate-pulse font-medium tracking-widest uppercase text-sm">
                                        Fetching logs...
                                    </td>
                                </tr>
                            ) : logs.length === 0 ? (
