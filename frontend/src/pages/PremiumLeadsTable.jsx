...
const PremiumLeadsTable = () => {
    ...
    const fetchLeads = async (pageToFetch, customOptions = {}) => {
        ...
        try {
            ...
            const res = await api.get(`/premium-data?page=${pageToFetch}&limit=${limit}&search=${encodeURIComponent(search)}&disposition=${encodeURIComponent(disp)}&quality=${encodeURIComponent(qual)}`);
...
export default PremiumLeadsTable;
