...
const RefineCampaigns = () => {
    ...
    const fetchCampaigns = async () => {
        try {
            const res = await api.get('/refine-campaigns');
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await api.delete(`/refine-campaigns/${id}`);
            fetchCampaigns();
        } catch (err) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button 
                    onClick={() => navigate('/refine-campaigns/add')}
                        ...
                        {campaigns.map(campaign => (
                            <tr key={campaign.campaign_id} className="hover:bg-white/[0.02] transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right space-x-3">
                                    ...
                                    <button 
                                        onClick={() => navigate(`/refine-campaigns/edit/${campaign.campaign_id}`)}
...
export default RefineCampaigns;
