    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 text-slate-200 font-sans pb-12">
            ...
            <div className="flex items-center space-x-2 text-[13px] text-slate-400 bg-[#1e1e2d] px-5 py-3.5 rounded-2xl shadow-sm border border-white/5 mx-auto">
                <Link to="/refine-sessions" className="text-brand-400 font-bold flex items-center cursor-pointer hover:text-brand-300 transition-colors">
                ...
                <div className="border-t border-white/10 pt-8 relative z-10">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        ...
                        <div className="flex space-x-3 w-full sm:w-auto">
                            <Link to={`/refine-sessions/${id}/add-job?bulk=true`} className="flex-1 sm:flex-none bg-[#0a0a0f] hover:bg-white/5 border border-white/10 text-slate-300 px-5 py-2.5 rounded-xl font-semibold transition-all flex items-center justify-center text-[13px] active:scale-[0.98]">
                                Bulk Upload
                            </Link>
                            <Link to={`/refine-sessions/${id}/add-job`} className="flex-1 sm:flex-none bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white px-6 py-2.5 rounded-xl font-semibold transition-all shadow-[0_4px_14px_rgba(234,88,12,0.3)] flex items-center justify-center gap-2 active:scale-[0.98] text-[13px]">
...
export default RefineSessionDetails;
