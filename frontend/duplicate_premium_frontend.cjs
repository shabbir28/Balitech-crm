...
const pagesToClone = [
  { src: 'RefineVendors.jsx', dest: 'PremiumVendors.jsx' },
  { src: 'RefineCampaigns.jsx', dest: 'PremiumCampaigns.jsx' },
  { src: 'RefineSessionsList.jsx', dest: 'PremiumSessionsList.jsx' },
  { src: 'RefineSessionDetails.jsx', dest: 'PremiumSessionDetails.jsx' },
  { src: 'RefineLeadsTable.jsx', dest: 'PremiumLeadsTable.jsx' },
  { src: 'RefineDownloadLeads.jsx', dest: 'PremiumDownloadLeads.jsx' },
  { src: 'RefineAlreadyDownloaded.jsx', dest: 'PremiumAlreadyDownloaded.jsx' }
];
...
console.log("Frontend duplication complete.");
